    ...
    <footer style={{ background: 'var(--ink)', color: 'var(--paper)' }}>
      ...
      <div style={{
        ...
        <div style={{ fontFamily: 'var(--f-sans)', fontSize: 13, lineHeight: 2 }}>
          ...
          <div><a href="https://www.facebook.com/share/1ECrhEapvS/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'none' }}>Facebook</a></div>
          <div><a href="https://maps.google.com/?q=Paradiesstrasse+2,+4102+Binningen" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'none' }}>Google</a></div>
        </div>
      </div>
      <div style={{
