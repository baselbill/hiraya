...
const MENU = {
  starters: {
    items: [
      ...
      { id: 'start-mis', name: 'Miso Suppe',    ingredients: 'Miso-Brühe · Tofu · Wakame',                                               price: 6,  kind: 'side', tags: ['veg'],  cooking: 'G' },
      { id: 'start-gun', name: 'Gunkan',        ingredients: 'Lachs scharf · Thun scharf · roter Kaviar · Wakame · Surimi',               price: 8,  kind: 'side', tags: ['spicy'], cooking: 'R', teaser: true },
      { id: 'start-tem', name: 'Temaki',        ingredients: 'Handrollen · Lachs · Thun · Surimi oder Gemüse',                           price: 10, kind: 'side', tags: [], cooking: 'R' },
      { id: 'start-tat', name: 'Fisch Tataki',  ingredients: 'angebratener Fisch · Ponzu-Dressing',                                      price: 16, kind: 'side', tags: [], cooking: 'G' },
      { id: 'start-sas', name: 'Fisch Sashimi', ingredients: 'frischer Fisch, in Scheiben · Wasabi · Ingwer',                            price: 15, kind: 'side', tags: [], cooking: 'R', priceFrom: true },
    ],
  },
  rolls: {
    items: [
      ...
      { id: 'roll-spt',  name: 'Spicy Tuna',           ingredients: 'Thun · Zwiebeln · Gurke',                                                              price: 10.00, priceFrom: true, kind: 'maki', tags: ['spicy'],                              img: '/hiraya/menu/roll-spt.png', cooking: 'R' },
      ...
      { id: 'roll-tbl',  name: 'Tuna Blast',           ingredients: 'Thun · Gurke · Avocado · Mango · Scharfe Sauce',                                       price: 10.50, priceFrom: true, kind: 'maki', tags: ['spicy'],                              img: '/hiraya/menu/roll-tbl.png', cooking: 'R' },
      ...
      { id: 'roll-kru',  name: 'Kiwi Rainbow Uramaki', ingredients: 'Apfel · Avocado · Karotten · Pistazie · Kiwi · Gurke · Sauce',                         price: 10.00, priceFrom: true, kind: 'maki', tags: ['veg'],                               img: '/hiraya/menu/roll-kru.png', cooking: 'G' },
      { id: 'roll-vip',  name: 'Patron Roll',          ingredients: 'Jakobsmuscheln · Karotten · Avocado · Gurke · Sauce',                                  price: 11.00, priceFrom: true, kind: 'maki', tags: ['veg'],                               img: '/hiraya/menu/roll-vip.png', cooking: 'R' },
      ...
      { id: 'roll-vfm',  name: 'Veggie Fotomaki',      ingredients: 'Avocado · Gurke · Mango · Radieschen · Apfel · Kampyo',                                price: 10.00, priceFrom: true, kind: 'maki', tags: ['veg'],                               cooking: 'G' },
    ],
  },
  sets: {
    items: [
      { id: 'set-mix2',  name: 'Mix Sushi 2',             ingredients: '14 Stück · 4 Uramaki · 4 Nigiri (2 Lachs, Crevetten, Thun) · 6 Hosomaki (Lachs, Avocado)', price: 24, kind: 'set', tags: [], teaser: true, img: '/hiraya/menu/set-mix2.png', cooking: 'R' },
      ...
      { id: 'set-vegi',  name: 'Mix Vegi',                ingredients: '11 Stück · 4 Veggi Rolls · 4 Vegi Maki · 3 Vegi Nigiri · Avocado · Mango · Gurke · Inari', price: 20, kind: 'set', tags: ['veg'],                         img: '/hiraya/menu/set-vegi.png', cooking: 'G' },
      { id: 'set-vhoso', name: '24 Stück Veggie Hosomaki',ingredients: '24 Stück · 6 Avocado Maki · 6 Mango Maki · 6 Gurken Maki · 6 eingelegte Rettich Maki',    price: 25, kind: 'set', tags: ['vegan'],                       img: '/hiraya/menu/set-vhoso.png', cooking: 'G' },
      { id: 'set-party', name: 'Sushi Party Platter',     ingredients: "Uramaki · Hosomaki · Nigiri · Sashimi oder Gunkan — Chefs Auswahl",                         price: 105, priceFrom: true, kind: 'set', tags: [],            img: '/hiraya/menu/set-party.png', cooking: 'R' },
    ],
  },
  poke: {
    items: [
      ...
      { id: 'poke-tu',   name: 'Thun Poke Bowl',       ingredients: 'Thun · Avocado · Gurke · Rettich · Edamame · Mango · Poke-Sauce',               price: 20.50, kind: 'bowl',  tags: [],                              img: '/hiraya/menu/poke-tu.png',  cooking: 'R' },
      ...
      { id: 'bento-lac', name: 'Lachs Bento Box',      ingredients: 'Sushi-Reis · flambierter Lachs · Marktsalat · 4 Nigiri · Wakame Salat · Sauce', price: 20.00, kind: 'bento', tags: [],                                                        cooking: 'F' },
      { id: 'bento-tu',  name: 'Thun Bento Box',       ingredients: 'Sushi-Reis · flambierter Thun · 4 Nigiri · Marktsalat · Wakame Salat · Sauce',  price: 20.00, kind: 'bento', tags: [],                                                        cooking: 'F' },
    ],
  },
};
